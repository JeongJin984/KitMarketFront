...
import { Row, Col, Card, Button, CardTitle, CardText, CardSubtitle, Form, FormGroup, UncontrolledPopover, PopoverHeader, PopoverBody, Badge, Label, Input, ButtonToggle } from 'reactstrap';
				...
				<Col xs = "8" style={{marginRight:'1%', flexWrap:'wrap'}}>
					<Card body outline style={{ backgroundColor: '#F3F3F2', borderColor: '#F3F3F2', height: 700 }}>
						...
						<Row>
							...
							<ButtonToggle color="secondary" onClick={()=>changeText("newText")}
								style={{
									marginLeft:'-120%',
									width:'90px',
									height:'90px',
